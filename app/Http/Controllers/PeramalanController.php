...
//PERAMALAN ORDER
//PERAMALAN ORDER
  public function peramalan0(Request $request) {

      // mendapatkan data pemesanan dari database berdasarkan request
      $data = Pemesanan::getDataPemesanan($request);

      $periode = Pemesanan::getPeriode($request);
      $X = Pemesanan::getTotal($periode, $data);
      $F = array();
      $e = array();
      $E = array();
      $AE = array();
